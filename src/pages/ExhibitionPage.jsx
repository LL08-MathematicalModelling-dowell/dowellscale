...
const[submitted,setSubmitted]=useState(-1)
    ...
    return(
        <div className="h-[640px] w-screen  relative ">
            ...
            {/* <div className=" absolute bottom-15 right-[27%] sm:right-[45%] md:mt-10 flex flex-col justify-center items-center"> */}
                ...
                <p className="w-full absolute bottom-20 mt-4 flex justify-center items-center text-[12px] sm:text-[14px]">Powered by uxlivinglab</p>
