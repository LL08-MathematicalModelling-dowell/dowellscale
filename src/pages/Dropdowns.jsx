...
const Dropdowns = () => {
  ...
  const handleSubmit = () => {
    if (channel && instance) {
      const url = `http://localhost:8003/dowellscale/samanta-edu/?workspace_id=66879a901c299b49c227088b&username=samantaeducation&channel=${channel}&instance=${instance}&scale_id=6687e18aa74d1fcdca15fde3`;
