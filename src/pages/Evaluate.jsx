...
export default function Evaluate(){
   const[submitted,setSubmitted]=useState(-1)
     ...
     function handleButtonClick(index){
      setSubmitted(index)
        window.location.href=`https://100035.pythonanywhere.com/addons/create-response/v3/?user=True&scale_type=learning_index&channel=channel_1&instance=instance_1&workspace_id=6385c0e48eca0fb652c9447b&username=HeenaK&scale_id=6669b6d93e3d1f04792176c9&item=${index}`
